...
//public class BinarySearchTree<AnyType extends Comparable<? super AnyType>>
{
    ...
    private BinaryNode<AnyType> insert( AnyType x, BinaryNode<AnyType> t )
    {
        ...
        /*To Do (If a node with x already exists in tree, do nothing)*/
        if(compareResult < 0)
    ...
    private AnyType find( AnyType x, BinaryNode<AnyType> t )
    {
        ...
        /*
         * the last part of this code makes sure that the two words are actually the same
         * because previously it would return yellow if you put in y as the search word 
         * because they start with the same letter
         */
        
        else {
        	if(t.element.toString().length() == x.toString().length())
        		return t.element;
        	else
        		return null;
        }
